Fully working & compilable Marlin Bugfix 2.0X for my own iFactory-One 3D Belt Printer*<br />

Annotated to assist anyone with compiling for the SKR 1.4 or SKR 1.4 Turbo MOBO' - listing all required alterations to work with a stock machine.<br />

*Currently Supported Mods':<br />
BMG Clone Extruder<br />
Z-Homing (requires Z Endstop)<br />
28* Neopixel LED's across top 2020 extrusion<br />
TMC 2209 Drivers (V1.2) X 5<br />
Sensorless X/Y homing<br />
True Dual Z Drivers <br />
Upgraded 2A 60mm Z Steppers (Motech 1705HS200A - Ooznest Spec')<br />
Upgraded 1.68A 0.9deg X/Y Steppers (Motech 1704HSM168A - Ooznest Spec')<br />
BTT 3.5-E3 V3 - Dual Mode Touch Screen Display<br /><br />
