...
// 3dm4rk - If using one driver and 2 steppers in Parallel mode enter 1 below:
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  /** 3dm4rk - Ideamaker seems to cause print completed (green LED) 
   * before it actually starts, I have reduced 
  timing to 90 seconds to save the 30 min default wait **/
    #define PE_LEDS_COMPLETED_TIME  (90) // (seconds) Time to keep the LED "done" color before restoring normal illumination
  #endif
 ...
 * Lowered homing current for greater sensitivity reaction and softer homing**/
    ...
    #define X_CURRENT_HOME  750//X_CURRENT  // (mA) RMS current for sensorless homing
    ...
    #define Y_CURRENT_HOME  750//Y_CURRENT
    #define Y_MICROSTEPS     16
   ...
   */
  /** 3dm4rk -Stealthchop enabled on XY only - Defaults to spreadcycle on E & Z **/
 ...
 // #define STEALTHCHOP_Z
  ...
  /** 3dm4rk - WIP..... Testing timings for 0.9deg steppers on X/Y **/

  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)
  //#define CHOPPER_TIMING_X  CHOPPER_09STEP_24V   // 0.9 degree steppers (24V) 
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    //#define SPI_ENDSTOPS              // TMC2130 only
      ...
      /** 3dm4rk - WIP..... Tring out below settings to 
       * increase homing success and reduce false positives **/
   ...
   */
    ...
    /** 3dm4rk - Enabled below to verify UART connections and params' via M122 **/
